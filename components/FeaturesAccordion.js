      ...
      <div className="px-8">
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-24">
          <div className="grid grid-cols-1 items-stretch gap-8 sm:gap-12 lg:grid-cols-2 lg:gap-20">
            <Accordion type="single" collapsible value={`item-${featureSelected}`}>
                ...
                <AccordionItem key={i} value={`item-${i}`}>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span className={`duration-200 ${featureSelected === i ? "text-primary" : ""}`}>
                        {feature.svg}
                      </span>
                      <span className={`flex-1 text-left ${featureSelected === i ? "text-primary font-semibold" : ""}`}>
                        {feature.title}
                      </span>
                    </div>
                  </AccordionTrigger>
