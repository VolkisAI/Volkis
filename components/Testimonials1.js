...
const Testimonial = () => {
  return (
    <section
      ...
      id="testimonials"
    >
      <div className="absolute inset-0 -z-10 bg-gradient-to-b from-muted to-background opacity-20" />
      ...
      <div className="mx-auto max-w-2xl lg:max-w-5xl">
        <figure className="mt-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="relative rounded-xl border border-border bg-muted/5 p-1.5 sm:-rotate-1">
              <Image
                width={320}
                height={320}
